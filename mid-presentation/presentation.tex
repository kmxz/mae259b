...
\begin{document}
	...
	\end{frame}
	\begin{frame}{Adaptive Time Stepping}
%		\begin{textblock}{0.3}[1,0](0.95,0.2)
%			\includegraphics[width=\textwidth]{res/branches.png}
%		\end{textblock}
		\begin{minipageparskip}{0.45\textwidth}
			\small
		...
		\begin{minipageparskip}{0.5\textwidth}
			...
			\hfill
			\begin{tikzpicture}
				\begin{axis}[width=6cm,height=4cm,xlabel={$t$ [$\mathrm s$]},ylabel={$F_{max}$ [$\mathrm N$]},xmax=0.1]
			...
			\hfill
			\begin{tikzpicture}
				\begin{axis}[width=6cm,height=4cm,xlabel={$t$ [$\mathrm s$]},ylabel={$dt$ [$\mathrm s$]},xmax=0.1]
