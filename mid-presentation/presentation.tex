...
\begin{document}
	...
	\begin{frame}{Surface friction considered}
		For all nodes in contact with the surface, a friction force proportional to its velocity is applied.
		\begin{widecenter}
			\resvideo{no-friction}{6.095}{4.635}
			\resvideo{friction-0.2}{4.6}{4.635}
		\end{widecenter}
	\end{frame}
